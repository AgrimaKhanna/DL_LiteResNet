...
if __name__ == '__main__': 
    ...
    train_dataset = torchvision.datasets.CIFAR100(root='../data_100', train=True, download=True, transform=train_transformations)
    ...
    test_dataset = torchvision.datasets.CIFAR100(root='../data_100', train=False, download=True, transform=test_transformations)
    ...
    with open(f"../plots/results_{exp}_cifar100.txt", "w") as file:
